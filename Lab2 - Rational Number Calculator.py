#Lab 2 (part 1)
#student name:      Rachael Peng
#student number:    87280806
...
class Rational:
    ...
    def add(self, secondRational: Rational) -> Rational:
        ...
        # If any denominators = 0, or any decimal numbers, resulting rational number 
        #     should be represented as invalid by numerator, denominator = 0
        # Otherwise calculates addition using formula: (a*d + b*c) / b*d
        if self.denominator != 0 and secondRational.denominator != 0:
            if type(self.numerator) != float and type(self.denominator) != float and type(secondRational.denominator) != float and \
                type(secondRational.numerator) != float:
    ...
    def subtract(self, secondRational: Rational) -> Rational:
        ...
        # If any denominators = 0, or any decimal numbers, resulting rational number 
        #     should be represented as invalid by numerator, denominator = 0
        # Otherwise calculates subtraction using formula: (a*d - b*c) / b*d
        if self.denominator != 0 and secondRational.denominator != 0:
            if type(self.numerator) != float and type(self.denominator) != float and type(secondRational.denominator) != float and \
                type(secondRational.numerator) != float:
                numerator = (self.numerator * secondRational.denominator) - (self.denominator * secondRational.numerator)
    ...
    def multiply(self, secondRational: Rational) -> Rational:
        ...
        # If any denominators = 0, or any decimal numbers, resulting rational number 
        #     should be represented as invalid by numerator, denominator = 0
        # Otherwise calculates multiplication using formula: a*c / b*d
        if self.denominator != 0 and secondRational.denominator != 0:
            if type(self.numerator) != float and type(self.denominator) != float and type(secondRational.denominator) != float and \
                type(secondRational.numerator) != float:
    ...
    def divide(self, secondRational: Rational) -> Rational:
        ...
        # If any denominators = 0, or any decimal numbers, resulting rational number 
        #     should be represented as invalid by numerator, denominator = 0
        # Otherwise calculates division using formula: a*c / b*d
        if self.denominator != 0 and secondRational.denominator != 0:
           if type(self.numerator) != float and type(self.denominator) != float and type(secondRational.denominator) != float and \
                type(secondRational.numerator) != float:
    ...
    def toString(self) -> str:
        ...
        # If any input numbers are non-numerical (i.e. character), all 4 input numbers = 0 = return NaN
        # Otherwise output calculations
        if self.denominator != 0:
            # special case if rational is an integer, doesn't display denominator
            if self.numerator % self.denominator == 0:
                stringReturned = str(self.numerator // self.denominator)
            else:
            # general ouput format numerator/denominator 
                stringReturned = f"{self.numerator}/{self.denominator}"
        # Special case if denominator = 0, not integer, returns NaN
        else:
            stringReturned = "NaN"
